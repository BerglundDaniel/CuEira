...
public:
  ...
  MOCK_CONST_METHOD0(getCSVFilePath, std::string());
  MOCK_CONST_METHOD0(getCSVIdColumnName, std::string());
  MOCK_CONST_METHOD0(getEnvironmentColumnName, std::string());
  ...
  MOCK_CONST_METHOD0(getCSVDelimiter, std::string());
