...
PinnedHostMatrix* DeviceToHost::transferMatrix(const DeviceMatrix& matrixDevice) const {
...
PinnedHostVector* DeviceToHost::transferVector(const DeviceVector& vectorDevice) const {
