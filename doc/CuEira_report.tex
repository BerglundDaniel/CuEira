...
\begin{figure}[h]
    ...
    \caption{Illustration of a simple case of confounding. If we do not observe Z we might falesly find an association between X and Y}
...
M=number of predictors excludig intercept
result beta is M+1
...
Depeding on where the point is interaction might not be relevant, e.g. needs to smoke a million ciggarets a day and case 3. Or disapers to fast, eg 1 cigarret a year case 4.
...
%TODO env recode, lägst risk blir högst etc. Dvs byter om intervalet. LR bry sig om steg/skala inte förflytning så *-1 är ok. Ger dock annat intercept men samma coefficents
