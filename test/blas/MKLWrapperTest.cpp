...
TEST_F(MKLWrapperTest, CopyVector) {
  const int size = 5;
  RegularHostVector vectorFrom(size);
  RegularHostVector vectorTo(size);
...
TEST_F(MKLWrapperTest, SVD) {
  ...
  double h;
  double x;
  RegularHostVector sigma(size);
  RegularHostMatrix matrix(size, size);
  RegularHostMatrix uSVD(size, size);
  RegularHostMatrix vtSVD(size, size);
...
TEST_F(MKLWrapperTest, matrixVectorMultiply) {
  ...
  RegularHostVector vector(numberOfColumns);
  RegularHostVector vectorRes(numberOfRows);
  RegularHostMatrix matrix1(numberOfRows, numberOfColumns);
...
TEST_F(MKLWrapperTest, matrixTransVectorMultiply) {
  ...
  RegularHostVector vector(numberOfColumns);
  RegularHostVector vectorRes(numberOfRows);
  RegularHostMatrix matrixT(numberOfColumns, numberOfRows);
...
TEST_F(MKLWrapperTest, matrixMatrixMultiply) {
  ...
  RegularHostMatrix matrix1(numberOfRows, numberOfColumns);
  RegularHostMatrix matrix2(numberOfRows2, numberOfColumns2);
  RegularHostMatrix matrixRes(numberOfRows, numberOfColumns2);
...
TEST_F(MKLWrapperTest, matrixTransMatrixMultiply) {
  ...
  RegularHostMatrix matrixT(numberOfRows, numberOfColumns);
  RegularHostMatrix matrix2(numberOfRows2, numberOfColumns2);
  RegularHostMatrix matrixRes(numberOfColumns, numberOfColumns2);
...
TEST_F(MKLWrapperTest, differenceElememtWise) {
  ...
  RegularHostVector vector1(size);
  RegularHostVector vector2(size);
  RegularHostVector vectorRes(size);
