...
\subsubsection{Fitting Logisitic Regression Models}
%TODO
...
In binary case it simplifies to the increase in odds when exposed
...
RR can not be esitmaded in case control since it requires prevalence in whole population which you need cohort studies to find. In case control it is approximate with OR.
