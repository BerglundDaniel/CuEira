 ...
 */
class ElementWiseDifferenceTest: public ::testing::Test {
protected:
  ElementWiseDifferenceTest();
  virtual ~ElementWiseDifferenceTest();
  virtual void SetUp();
...
ElementWiseDifferenceTest::ElementWiseDifferenceTest() :
...
void ElementWiseDifferenceTest::SetUp() {

}

void ElementWiseDifferenceTest::TearDown() {

}

TEST_F(ElementWiseDifferenceTest, KernelSmallVector) {
  ...
  stream->syncStream();
  handleCudaStatus(cudaGetLastError(), "Error in ElementWiseDifferenceTest: ");
...
TEST_F(ElementWiseDifferenceTest, KernelException) {
  const int numberOfRows = 5;
  ...
  EXPECT_THROW(kernelWrapper.elementWiseDifference(*deviceVector1, *deviceVector2, *resultDeviceVector), CudaException);
