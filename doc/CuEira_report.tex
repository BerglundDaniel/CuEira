...
%TODO coloring and format geira code
\begin{algorithm}
\DontPrintSemicolon
\SetKwInOut{data}{Data}
\BlankLine \BlankLine

\data{CaMaxn and CoMaxn is the frequency for the cases and controls. CaMax and CoMax is the name of the allele that has the highest frequency in cases and controls.}

\BlankLine \BlankLine

\If{$CaMaxn > CoMaxn$ \& $CaMax == CoMax$}{
  $crisk \longleftarrow CaMax$\;
}\ElseIf{$CaMaxn <= CoMaxn$ \& $CaMin == CoMin$}{
  $crisk \longleftarrow CaMin$\;
}\ElseIf{$CaMaxn > CoMaxn$ \& $CaMax != CoMax$}{
  $crisk \longleftarrow CaMax$\;
}\ElseIf{$CaMaxn <= CoMaxn$ \& $CaMin != CoMin$}{
  $crisk \longleftarrow CaMin$\;
}
...
%TODO coloring and format jeira/geisa code
\begin{algorithm}
\DontPrintSemicolon
\SetKwInOut{data}{Data}
\BlankLine \BlankLine
